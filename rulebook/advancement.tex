...
\renewcommand{\yggAdvancementText}{%
 ...
 \mysection{Glory}{advancement-glory}
  ...
  Your adventures will bring you Glory, allowing you to become more powerful. When you accumulate enough Glory, you add 1 to your level (so level 1 becomes level 2, level 2 becomes level 3, etc) and you increase your Grit and obtain new Virtues, or strengthen ones you already have.


  \mytable{X c c }{
    \thead{Level} & \thead{Min Glory} & \thead{Coin Type} \\
  }{
    1 & 0 & Iron \\
    2 & 1,000 & Iron \\
    3 & 3,000 & Silver \\
...
Treasure you loot on your adventures must be spent in order to convert it to Glory.  Money you acquire and spend outside of an Adventure doesn't count (so if you pickpocket some rube or setup an opium trade or steal from the king it doesn't count, unless the chapter of your Adventure is entitled "Steal Shit from the King").  This is up to the Arbiter's discretion.

Levels 1 and 2 are the \mybold{Iron levels}.  You get 1 Glory for every iron piece you loot AND spend in Civilization.  These don't have to be Iron pieces per se -  if you were to loot and spend a single \AU, you would gain 100 Glory (but you would need to be in a larger civilization to spend it!)

Levels 3, 4, and 5 are the \mybold{Silver levels}.  You get 1 Glory for every silver piece you loot AND spend in Civilization 

Levels 6+ are the gold levels.  You get 1 Glory for for every gold piece you loot AND spend in Civilization


Any coins you spend in Civilization are converted to Glory on a 1-to-1 basis, including:
...
You'll note that it gets harder and harder to gain Glory with money as you go up in level.  This is by design - legendary heroes aren't getting Glory taking money from orc babies, but by doing epic shit i.e. writing chapters in their Adventure.  In time, the jewels cease to sparkle...



\mysection{Carousing}{advancement-carousing}

If you've spent all the money you can, Carousing is a way to convert any extra coins you've got lying around into Glory on a 1-for-1 basis. Say how much money you're going to burn and roll a d20 on the chart below.  You get a +1 for every 100 coins you spend (rounded down)

\cbreak

If you decide to go Carousing with a Pooka, you roll a d24 instead.  If a Pooka goes Carousing with you, \myital{they} get an additional 10\% of any Glory you gained, but they also have to roll a d20 on the table below.
...
\end{multicols}   
    ...
    \begin{center}
      \includegraphics[scale=0.7]{Carousing}
    \end{center}
...
\mytable{l X}{
  ...
  3 & Talk shit and get called out. You get the Glory for this Carousing, but you can't get any more until you do something really awesome designated by the Arbiter, like killing a legendary monster or stealing a legendary treasure. \\
  ...
  6 & Are inducted into a cult. It takes your friends the rest of the Vacation to deprogram you.  Carousing earned you  -10\% Glory \\
  ...
  9 & Are mistaken for someone else, and charged with their tab. Pay 30\% more money (no Glory for it) or wake up in the slammer. \\
 ...
 13 &Gain 3 rumors about the next adventure  \\
  ...
  19 &  Are mistaken for an important figure and the party gets really going. +25\% Glory.  \\
...
you can pick from the Any, Iron, Silver, or Gold lists
  ...
  \mylist {
    ...
    \begin{center}
  \includegraphics[scale=.5]{SeatedWizard}
  \end{center}
 ...
 \cbreak
  ...
  \adlist {
    \item Learn a new skill as if you were Trained in it (d8+1)
  ...
  \adlist {
    ...
    \item Learn the \mylink{The Crux of Knowledge}{philosopher-virtue-knowledge} \mybold{[Unique]} \\~ \\~  If you already know it, you can learn an additional \mylink{Remedy}{arcana-leechcraft}. \mybold{[Special]} 
    \item Learn \mylink{Invocation}{philosopher-virtue-invocation}  \mybold{[Unique]}   \\~ \\~  If you already know it, add 3 additional \mylink{random spells}{table-random-spells} to your Grimoire. \mybold{[Special]}
    \item Learn \mylink{Leechcraft}{philosopher-virtue-leechcraft}. \mybold{[Unique]}
    ...
    \item \mybold{Study:} If your Knowledge Die is a d6 or a d10, increase it \DCUP (to d8 or d12, respectively) \mybold{[Unique]}
    \item Learn \mybold{Wonder: Staff Magic} \mybold{[Unique]} 
    \item Gain 3 Fetishes (d4 \UD) each containing 1 Wizardry arcana of your choice
  }
  ...
  \adlist {
    ...
    \item Learn \mylink{Aura}{mystic-virtue-aura}.  Requires the Crux of Mojo. \mybold{[Unique]} 
  ...
  \adlist {
    ...
    \begin{center}
      \includegraphics[scale=.5]{DeerSkulls}
    \end{center}
  ...
  \adlist {
    ...
    \item Gain a piece of equipment from the Veins of the Earth source-book.
    \item Gain +4 Grit \mybold{[Special]}
    \item \mybold{Assassin:} Learn the Knave \mylink{Whisper of The Bride}{knave-whisper-the-bride} at the rank of Apprentice (d4). \mybold{[Unique]}
  ...
  \adlist {
    ...
    \item \mybold{Briar Patch:} Learn the Knave \mylink{Whispers of Br'er Rabbit}{knave-whisper-brer-rabbit} at the rank of Apprentice (d4) \mybold{[Unique]}
  ...
  \includegraphics[scale=.5]{Archer}
  ...
  \example {
    \mybold{All Silver Virtues are Unique unless otherwise specified.}
  }
  ...
  \adlist{
    ...
    \item \mybold{Berserker}:  If you are \mylink{Dying}{combat-dying}, you may continue to fight.  Gain +8 to Fight and Guard rolls.  This bonus ends the moment you go above 0 Flesh.  While at 0 Flesh, you will still have to roll your \DEATH at the top of each moment.  Roll your Sanity and roll for a Wound at the end of Combat.
...
\begin{center}
  \includegraphics[scale=.5]{ManHat}
\end{center}
...
\adlist {
    ...
    \item \mybold{Safe House:} Depending on the size of a Civilization you're in, you have a chance (Small: 25\%, Medium 75\%, Large 100\%) of finding other practitioners of your faith - a coven, cult, church, or what-have-you.  Your brethren will give you information, food, and lodging for free - the amount of money you must pay to take a \mylink{Vacation}{civilization-vacation} reduced by half, but you still get the full Glory as if you had spent the full amount.  The Arbiter must share a rumor with you about your current or next adventure - the clue might be obscure, but it must be true
  ...
  \adlist {
    \item \mybold{Arcane Armory:} Once per Session, you can touch as many iron weapons you wish and make them magical for 1 Minute.  Each weapon you touch will deal 1 Flesh damage to you.  The weapon will stay enchanted for Hours.  The weapon has no additional characteristics, but can hit Monsters only affected by Magic
  ...
  \adlist {
    \item \mybold{Invisibility:} Once per Session, you can step into a shadow and become \mylink{Invisible}{effect-invisible}.  You can use this to get the Drop on someone, but there must be a shadow present (you couldn't do this in the middle of a sunny field, for example)

    \item \mybold{Stone Shape:} Once per Session, you can speak to stones and have them reshape themselves.  The stones can't be bigger than 1m in any dimension.  The stone will reshape itself into anything you desire - a large rock could be shaped into a idol, a passage could be made through a wall (provided the wall was less than 1m thick).  The object created is rough hewn - fine detail isn't possible (Arbiter's discretion)

    \item \mybold{Shadowblade:} You can reach into a shadow and pull out a dagger. The dagger exists for as long as it is not exposed to sunlight.  The dagger is magical and does d10 damage, and can have Toxins applied to it.  If the dagger takes a life it immediately dissipates
  ...
  \adlist {
    ...
    \item \mybold{Surprise, Motherfucker!}  Markovian effects are immediately reduced by \DCDOWN x2 for you (meaning a d8 Markovian effect will only be a d4, and a d4 will have no effect).

  }

  \begin{center}
      \includegraphics[scale=.5]{LaughingMan}
    \end{center}
  ...
  \adlist {
    ...
    \item  \mybold{The Guild} You become the focal point of a new Thieves Guild.  3 \mylink{Henchmen}{gear-henchmen} with Orderly morale join your cause; they expect nominal pay, room, and board - otherwise, they will need to make periodic Morale checks at the discretion of the Arbiter. Outside of Combat, these thieves can each (a) grant you +1 to any \RO attempt; (b) grant you +1 to any \KNAVE attempt; (c) take any physical damage (like from a trap) for you.  The Knaves have 8 Flesh and wear no armor.  You can never have more than 3 Knaves in your employ at a time.
  }

  \myhighlight{Philosophers}{advancement-leveling-gold-philosophers}

  \adlist {
     \item  \mybold{Study:} If your Knowledge Die is a d10 or a d16, increase it \DCUP (to d12 or d20, respectively)
      ...
      \item \mybold{Apprentice}.  An apprentice joins you.  They are \mylink{Henchmen}{gear-henchmen} with Cowardly morale; they expect nominal pay, room, and board - otherwise, they will need to make periodic Morale checks at the discretion of the Arbiter.  They have 4 Flesh and wear no armor. The apprentice can (a) carry as many Grimoires or Fetishes as you wish without it taking any inventory space; (b) grant you +3 Research; (c) grant you +2 to your Leechcraft rolls; and (d) take any physical damage for you.  You can only have 1 apprentice at any time.
  }
...
\begin{center}
  \includegraphics[scale=.5]{Odin_1}
\end{center}
...
You can't separate the eye, ear, and mouth - they have to remain together.  The eye, ear, and mouth can fit through a space that you could reasonably pass the real thing through (a mouse hole, but not under a door)
  ...
  \begin{center}
      \includegraphics[scale=.5]{LittleWitch}
    \end{center}
  ...
  \adlist {
    ...
    \item \mybold{Otherwordly:} You can only be hurt by magical weapons, spells, and fire \mybold{[Unique]}
  }
