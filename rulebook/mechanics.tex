...
In a Roll 20 try, you have to roll a 20 or better with a combination of dice and modifiers. A 19 misses, a 20 succeeds. 

\mysubsection{Roll to Beat}{rolls-roll-to-beat}

In a Roll to Beat try, you roll one or more dice with modifiers and try to beat 1 or more other \RB rolls.  The type of dice will be defined with the \RB.
...
In a Roll to Succeed try, you must roll a die without rolling a Failure (a natural 1 or 2).  \RS rolls cannot be modified (though they can sometimes be changed).  
...
\begin{center}
\includegraphics[scale=.45]{Moonscape}
\end{center}
...
Confidence, attractiveness, leadership, and intimidation. The Arbiter might ask you if you'd like to try a \RS with your Presence \UD if you're trying to sweet talk someone, keep a group of peons from breaking morale, or scaring a couple of kobolds into telling you what you want to know. 
...
It always seems like you're in the right place at the right time, or that you have the favor of the Gods. The Arbiter might ask you if you'd like to try a \RS with your Talent \UD if you're trying to see if something works by pure random luck ("I randomly press buttons on the console and hope something good happens"; "I close my eyes and try to jump off the roof into the hay cart").  
...
Your idle perception, your "sixth sense".   The Arbiter might ask you if you'd like to try a \RS with your Awareness \UD to see if you notice something that you might not be actively looking for (you can say no!).  
...
Bearing witness to horrible or terrible things will prompt a try with your Sanity \UD.  If you roll a Failure, you must roll on the \mylink{Terrifying Tables}{misc-terrifying-tables} (the Arbiter will determine which table to roll on). 

Examples that might prompt a Sanity roll:  witnessing a member of the party getting killed; a horrifying creature you've never seen before; a situation that shakes your beliefs; or surviving a brush with \mylink{Death}{combat-dying}
