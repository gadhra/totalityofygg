...
\renewcommand{\yggCivilizationText}{%
  ...
  \begin{center}
  \includegraphics[scale=.5]{Moneychanger}
  \end{center}
...
\newpage
  ...
  \mybullet {
    ...
    \item Restore all Sovereignty (Spriggan)
  }
  ...
  \mybullet {
    \item  Perform \mylink{Research}{research} and \mylink{Marvels}{marvels}, or create \mylink{Wonders}{wonders}
  ...
  \begin{center}
  \includegraphics[scale=.5]{Vacation}
  \end{center}
  ...
  Not all Settlements have all the services an adventurer may require:
    ...
    \begin{center}
  \includegraphics[scale=.5]{MiracleWorker}
  \end{center}
  ...
  \mybullet {
    ...
    \item Not all Settlements have shrines or chapels to specific Small Gods, so their worshipers may not be present
  ...
  \mytable{X c c c c}{
    ...
    Shrine to a specific Small God? & 2-in-6 & 4-in-6 & 3-in-6 & 6-in-6 \\
    Library? & No & 2-in-6 & 4-in-6 & 6-in-6 \\
    Narcotics? & No & \MAX-in-6 & 6-in-6 & 6-in-6 \\
    Sanitarium? & No & 3-in-6 & 6-in-6 & 6-in-6 \\
  }
  ...
  \begin{center}
  \includegraphics[scale=.5]{WizardAndCat}
  \end{center}
  ...
  \myhighlight{Skaldic}{dialect-skaldic}
