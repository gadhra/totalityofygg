...
\renewcommand{\yggCombatText}{%
  ...
  \mybullet {
    ...
    \item A Combat Action: \mylink{Fighting}{combat-fighting} or \mylink{Deed}{combat-mighty-deeds}
  }
  ...
  \myhighlight{Deeds}{combat-mighty-deeds}

   \mynumlist {
    \item You can only use one Deed at a time i.e. you can't use Bum Rush and Florentine at the same time
    \item Unless it says otherwise, bonuses and penalties to Fight or Guard occur for a single \RO check
    \item Deeds are Combat Actions, and Combat Actions end your Moment
  } 

  \myhighlight{Bash}{combat-deeds-bash}
  \myital{Must have a shield equipped (it has to be on your arm / you have to be using it)}

  Get the Monster's attention.  Take a Fighting Action, but deal damage as if you were \mylink{Unarmed}{combat-damage-unarmed}.   If you hit, the Monster will attack you at the next opportunity.
  ...
  Take a Fighting Action.  If your try succeeds, make a \RB \VIG or \RB \DEX (your choice) vs. your opponent's \VIG or \DEX (Arbiter's choice). If you win you deal no damage, but your opponent is \mylink{Disarmed}{effect-disarmed}.

  \myhighlight{Florentine}{combat-deeds-florentine}
  \myital{Fast Brawl weapons only, but see below. \DEX d12 or better}

  Take a Fight Action with 2 weapons.  If you hit, roll damage for both weapons.  Pick the highest:
  ...
  \mysubsection{Fighting Action}{combat-fighting}
  ...
  The damage your weapon does is a \STATIC die.  Weapon damage is found in \mylink{Equipment}{gear-weapons}.  You roll the \STATIC and deal that much damage to the Monster.  If you roll a 1, you might Fumble.  If you roll \MAX damage on the die, you might Crit.
...
Flesh is generally pretty static; if you're ever at a point where you're taking damage to Flesh, you're getting pretty close to \mylink{Dying}{combat-dying}.
  ...
  Curses can be removed by Mystics using a \mylink{Hekaphage}{occultism-hekaphage};  Disease, Addiction, and \mylink{Wounds}{appendixa-combat-tables-wounds} can be healed by Philosophers using \mylink{Medicinals}{research-medicinals}. 

  If you don't have a Mystic or Philosopher in your Band, things get a little more complicated.  You'll need to find yourself a \mylink{Miracle Worker}{civilization-services} to cure what ails you.  Miracle Workers can heal 1 injury for a 100 coins appropriate to your level, and a roll on the
  ...
  While your Flesh is at 0, you must roll a \DEATH at the \mylink{top of each Moment}{time-top-bottom}.  If you fail, you immediately perish.  While at 0 Flesh you can't do anything but crawl to safety and hold your intestines in.
  ...
  \mybullet {
    ...
    \item Remove a single non-serious wound
  }
  ...
  \mybullet {
    ...
    \item \mylink{Philosophers}{trope-philosopher} restore up to 2 Blood \POOL and/or reset any negative modifiers to Knowledge
    \item \mylink{Mystics}{trope-mystic} restore up to 2 Grace \POOL and/or 1 Mojo \UD
    \item \mylink{Spriggan}{species-spriggan} restore all their Sovereignty
  }


  \mysubsection{Taking a Vacation (Days/Weeks)}{combat-resting-vacation}

  As your injuries mount you may find you need to take a longer rest.  Longer rests require \mylink{Civilization}{civilization}.
