...
table}{table-calamity}. The spell fails.
...
spell fails and you suffer a \mylink{Calamity}{table-calamity}.
...
\mylink{The Mysteries}{sorcerer-mysteries}.  These are all the spells you
understand.
...
\mysection{Wizards' Duel}{sorcerers-wizards-duel}
...
\mylink{Calamity}{sorcerer-blood} or \mylink{Ruin}{sorcerer-ruin}, the
counterspell doesn't work. 


\mysection{Grimoires}{sorcerery-grimoires}
...
\mysection{Fetishes}{sorcerery-fetishes}
...
\mylink{\mybold{Wizard Sigil}}{sigil-wizard}
...
\mylink{\mybold{ Elemental Sigil}}{sigil-elemental}
...
\mylink{\mybold{ Warding Sigil}}{sigil-warding}
...
\mylink{\mybold{ Cursing Sigil}}{sigil-cursing}

This Sigil can only be created with the help of a Witch's \mylink{Malison}{occultism-malison}, or a \mylink{Mystic of Vecna}{small-gods-vecna}.  The Curse is placed within the Sigil.  When anyone comes Close to an object with the Sigil on it, they must Save vs. Hexes or fall victim to the curse.  If there is more than 1 target, they should hold a Luck contest. 

\mylink{\mybold{ Petrifying Sigil}}{sigil-petrifying}
...
\mylink{\mybold{Portal Sigil}}{sigil-portal}
...
\mylink{\mybold{ Erasing Sigil }}{sigil-erasing}
...
\mylink{\mybold{Remembrance Sigil}}{sigil-remembrance}

When created with a Spriggan present, they can place one of the \mylink{Obliterated}{spriggan-obliterated} inside of the Sigil.  The summoning of the Obliterated does not "lock" the \mylink{Remembrance Dice}{spriggan-remembrance} of the Spriggan.  The Spriggan cannot use more Remembrance Dice than the Research Dice you used to create the Sigil (though they can use the same amount).  
...
\mylink{\mybold{Revisitation Sigil}}{sigil-revisitation}
