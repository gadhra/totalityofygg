...
\renewcommand{\yggMortalsText}{%
  ...
  \myhighlight{Gloomstride}{knave-gloomstride} \\
  ...
  \myhighlight{Monkeys' Paws}{knave-monkeys-paws} \\
  ...
  You may also use your \LUCK to affect this result, but \mybold{the difficulty is subtracted from your Luck roll}.  You cannot go below 0 in this way.
  ...
  If you get \mylink{The Drop}{combat-surprise} on someone, you can attempt a Murder.  Murder can only be performed at Close range with a Shortsword, Dagger, Club, or Hand Axe (Bravos are allowed to use Bows and Strongbows, but only on targets Nearby).  Make a Fight \RO, adding your \LVL as a modifier. If you hit, pick \mybold{one} of the following attacks:
  ...
  \example {
    Flink Lighthand and Stalwart Hamhands (a Level 3 Soldier) come around the corner and surprise a clutch of three Ghouls.  Because they are surprised, Flink has The Drop.  He tries to \RO his Fight + \LVL, and hits.  He opts to attack recklessly and rolls 3d6 and gets an 11 - the lead Ghoul gets a shortsword through the belly and drops.  Stalwart neatly beheads another, leaving a single Ghoul (who makes his morale roll).   

    ~\\

    Flink and Stalwart roll Init - Flink rolls well over 20, Stalwart less so (he's wearing plate mail, after all).  Flink takes the opportunity to Gloomstride.  The Arbiter gives the difficulty a 3 (2 for the Monster's \HD and 1 because the Ghoul is Close and aware Flink's there, though he's mostly focussed on the huge armored guy with a longsword). Flink rolls his d6 and gets a 5, and slips out of view.  The Ghoul attacks Stalwart and hits, but Stalwart is able to absorb the damage with his Grit.  It's Stalwart and Flink's turn - Flink steps out behind the Ghoul and opts for a "Cautious" approach, makes his Fight + \LVL \RO, and deals 9 damage with his shortsword (6 + \LVL).  Stalwart finishes the creature off with a quick thrust through the heart.
  }   
  ...
  \mybold{Sniper Shot}
  You can use a \mylink{Bow}{gear-weapons} or \mylink{Strongbow}{gear-weapons} to commit Murder. You must still get The Drop, and the target cannot be further away than Nearby (and cannot be Close)

  \mybold{Red Herring}
  You know the additional \myanchor{Whisper: Red Herring}{whisper-red-herring}.  You use minor illusions, shadows, and hypnotism to disguise yourself as someone else.
  ...
  \mybullet {
    ...
    \item \mybold{Level 5:}   Once per Session, you can step into a shadow and become \mylink{Invisible}{effects-invisible}.  You can use this to get the Drop on someone, but there must be a shadow present (you couldn't do this in the middle of a sunny field, for example).  
  ...
  \mybold{Foyst}
  You know the additional \myanchor{Whisper: Foyst}{whisper-foyst}.  You use minor illusions and tricks of the eye to misdirect, allowing you to pick pockets or palm trinkets. 
  ...
  \mybullet {
    \item \mybold{Level 3:}  Once per Session, you can automatically escape from something that is restraining you and that you could plausibly escape from. This includes grapples, lynchings, and awkward social situations, but not sealed coffins 
    \item \mybold{Level 5:}  You always get two rolls on your \DEATH (pick the one you want to use).
  ...
  \mybullet {
    \item \mybold{Level 3:}   You can attempt to crossbreed and combine two spells into one new spell. Both spells need to be stored on separate scrolls or in separate books initially. This process can only be done during a Sabbatical. You can combine the spells to produce a random spell from one of the original spells' paradigms (so if one spell is Elements and the other is Force, the resulting spell will either be Elements or Force). When the process is complete, Save vs. Doom or suffer a Calamity (including the failure!). Gain a +1 bonus to Save for every 1,000 coins spent on reagents, inks, magical artifacts, incense, or other tools of your trade
    \item \mybold{Level 5:}   You can attempt to learn any spell you choose.  The spell must be scribed into a spellbook with enough room to hold it (spellbooks can hold a maximum of 10 spells).  When the process is complete, Save vs. Doom or suffer a Calamity (including the failure!).  You gain a +1 bonus to Save for every 5,000 coins (au) spent on reagents, inks, magical artifacts, incense, or other tools of your trade.
    \item \mybold{Level 7:}  You can attempt to create your own spell. Work out the details with the Arbiter.  It'll cost you a minimum of 10,000 coins (au). Failure means you suffer a Ruin.
  }
