...
\renewcommand{\yggMortalsText}{%
  ...
  If you get \mylink{The Drop}{combat-surprise} on someone, you can attempt a Murder.  Murder can only be performed at Close range with a Shortsword, Dagger, Club, or Hand Axe (though \mylink{Bravos}{flavo-bravo} can use more powerful weapons).  Make a Fight \RO, adding your \LVL as a modifier. If you hit, pick \mybold{one} of the following attacks:
  ...
  When attempting a Murder, you may use a \mylink{War Axe}{gear-weapons} or \mylink{Longsword}{gear-weapons}.  If you manage to slay the Monster, you may invoke the War Axe trait of \mylink{Cleave}{gear-weapon-cleave} to attack another Monster, but it doesn't count as a Murder (you no longer have The Drop).
