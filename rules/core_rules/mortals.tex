...
\renewcommand{\yggMortalsText}{%
  ...
  When attempting a Murder, you may use a \mylink{War Axe}{gear-weapons}, \mylink{Spear}{gear-weapons}, or \mylink{Mace}{gear-weapons}. You still must be Close to the Monster.  If you are using a War Axe and manage to slay the Monster, you may invoke the War Axe's \mylink{Cleave}{gear-weapon-cleave} ability to attack another Monster, but it doesn't count as a Murder, as you no longer have The Drop.

  \mybold{Red Herring}
  You know the additional \myanchor{Whisper: Red Herring}{whisper-red-herring}.  You use minor illusions, shadows, and hypnotism to disguise yourself as someone else, or convince someone that the forgery you've handed them is legitimate.
