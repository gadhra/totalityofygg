...
\renewcommand{\yggMortalsText}{%
 ...
 You are marked by the sign of Kib, and blessed with a soul (the \myital{noumenon}, the "thing in itself").  Because you have a soul, you are Hallowed; a member of the Tribes sacred to \TheAuthority.  Hallowed things stand in opposition to Magic - the phenomenon whose rules are bound by Chaos rather than Order.
  ...
  \callout{
    ...
    If you roll \MAX damage for your weapon, the die explodes i.e. you roll again and add the second roll to the first.  If you roll \MAX damage again, the roll continues.  This roll has to be a \myital{natural} (not modified) roll (though some powers and abilities can change a natural roll).  Modifiers to damage are added or subtracted  \mybold{after}  the die explodes (including Deed Die).  Note that this means you can't \mylink{Crit}{combat-crit} since your last roll is never technically the \MAX. 
    ...
    You have some experience with a prior \mylink{Band}{about-the-band}.  You start with d6+1 Grit.  Tell the Arbiter the name of your old \mylink{Band}{about-the-band}, and what happened to them.
    ...
    You do not like or trust magic, \mylink{Philosophers}{trope-philosopher}, or the unnatural (including \mylink{The Unseelie}{unseelie-adventurers}).  The degree to which you feel this way is up to you.  Let the Arbiter know why.
 ...
 \cbreak
    ...
    You're a professional, and you appreciate other professionals.  You'll always give a hand to a fellow Knave even if that might inconvenience your \mylink{Band}{about-the-band}.
  ...
  \myhighlight{The Research Die}{philosopher-research-die}

  Philosophers can build Research Dice when they are taking a \mylink{Vacation}{civilization-vacation}.  
  ...
  Put a stopper in death.  Create potions and salves, toxins and acids using Research Dice based on your \INT.\footnotemark[\value{footnote}]

  \myhighlight{Research: Inscription}{philosopher-virtue-inscription}
  
  Klaatu barada nikto! Read and write magical texts and inscriptions, divine words of power, and research True Names using Research Dice based on your \INT.\footnotemark[\value{footnote}]

  \myhighlight{Research: Medicinals}{philosopher-virtue-medicinals}

  Cure diseases, addictions, and madness through the power of science, using Research Dice based on your \INT.\footnotemark[\value{footnote}]
  ...
  You require corpses - fresher the better - to perform Research (Chymistry, Inscription, or Medicinals).  You'll need at least 1 fresh corpse if you want to spend Research Dice during a \mylink{Vacation}{civilization-vacation}. 
 ...
 \myhighlight{Out of Shape}{philosopher-out-of-shape}
  ...
  You require narcotics to do Research (Chymistry, Inscription, or Medicinals).  Pick a \mylink{Narcotic}{civilization-narcotics} with a Potency of at least 2.  You must roll a \UD of this Narcotic any time you spend Research Dice during a \mylink{Vacation}{civilization-vacation}.
...
\example{Eyeball, Research: Inscription, Research: Chymistry, College, Transcendental Research}
  ...
  \callout{
    ...
    You gain 2 d4 Cunning \POOL; you can use these dice to practice Occultism.  Your fate is also now guided by the waxing and waning of the moons and planets.  You gain a Familiar.\footnotemark[\value{footnote}]
    ...
    \mylist {
      ...
      \item a \mylink{Mule}{civilization-transport};
