...
\renewcommand{\yggSkillsSavesText}{%
  ...
  A skill roll is a \KNACK die to see if something is possible and achievable.  The Arbiter may call for a Skill check 

  \mylist {
    \item when the difference between success and failure would be interesting; or
  ...
  If you are the first person making a skill roll, your die roll doesn't just determine if you succeed, but \myital{whether or not something is even possible}.  If you roll and fail at something like lighting a fire in a dungeon (Bushcraft), it means that it's simply not possible in these conditions.  Might have to do with your actions, might not. It was too damp in the dungeon. You got the tinder wet.  The wood is sodden. Who knows, but it's just not possible, you tried, failed, and now you know. 

  If you were a sailor and rolled a skill check on Salt, you're going to have a better chance of success.  But if someone fails their Salt roll before you had a chance to try, then they fucked up - they should have waited for the professional to give it a shot (but they didn't - and tore the mainsail/tacked the ship incorrectly/didn't account for the tide).  This might be a permanent effect or it might just be for a little while, up to the Arbiter's discretion.

  After the first person succeeds, everyone else is able to follow along behind them.  None of these additional rolls have any effect on whether things are possible or not (if adventurer 1 succeeds, it's possible, and adventurer 2 failing doesn't make it impossible).  At the Arbiter's discretion, a bonus may apply to these future rolls (watching the scout climb the mountain gives you a sense of where to put your hands, so now you have a 2-in-6 instead of a 1-in-6 chance).

  \cbreak
  
  \mysubsection{Skill List}{skills-list}
