...
Touching Death's Door is not without its cost.  Roll a d3:  1) Physical Wound, 2) Mental Wound, 3) Spiritual Wound.  The effects of Wounds are healed by taking a Bivouac unless the damage is permanent (a Beating, Madness, or Life Drain).  Those can only be healed during a \mylink{Vacation}{civilization-vacation}.
...
\mynumlist {
  ...
  \item  Roll on the \mylink{Beatings}{appendixa-beatings-table} table
}
