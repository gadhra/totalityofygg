...
\renewcommand{\yggFaeText}{%
  ...
  \mybold{Mountaineer}
  When climbing anything made of stone, you know the \mylink{Whisper:Monkeys' Paws}{knave-monkeys-paws} as if you had a \KNAVE of d8 (you can speak to the stones to find the best handholds, etc)
