...
\renewcommand{\yggFaeText}{%
  ...
  \mybullet {
    \item If you are a \mylink{Pooka}{flavor-pooka}, you can hail from any \mylink{Small, Medium, or Large}{civilization-table} in Acheron.  Pooka are commonly sailors (they bring good luck), jesters, scouts, and tavern keepers - and rarely gamblers, since no one will play with them
    ...
    \item If you are a \mylink{Murk}{flavor-murk}, you originally hailed from the \mylink{Veins of the Earth}{civilization-veins-of-the-earth} - but you can live in any town or city on the frontiers.
    \item If you are a \mylink{Night Child}{flavor-night-child}, you hail from any \mylink{Medium or Large}{civilization-table} in Acheron, or somewhere far away from \myital{any} civilization
  }
  ...
  \HD d4 \hfill Primary Stat: Presence
  ...
  \mybold{Party Hearty}
  For any narcotics you take, (a) the \UD only moves \DCDOWN if you roll a 1, (b) you add your \LVL to your \mylink{Addiction}{civilization-narcotics-addiction} roll, and (c) if you \mylink{Overdose}{civilization-narcotics-overdose}, you don't have to roll a \mylink{Save vs. Toxins}{saves} (nothing happens except you wasted some drugs).  When you take a Sojourn or Sabbatical, you have a 2-in-6 chance of obtaining \myital{any} \mylink{Common Narcotic}{civilization-narcotics} for free (even Narcotics that would normally not be available, like Black Lotus in a Small town)

  \mybold{Apotropaic}
  Your presence in a party nullifies any effects of the Malocchio.  If you're taking a \mylink{Bivouac}{combat-resting}, there is no chance of wandering Monsters. Buildings where you are sleeping are warded from casual attack (meaning the building would be spared in a riot, for example). 
  ...
  \mybold{Luck Battery}
  You have a Luck \UD, similar to \mylink{Knaves}{trope-knaves}, and you can use it to help other Allies (but not yourself).  You can roll this Luck \UD at any time to affect someone's \RO or \RB attempt, or to give them a 6-in-6 on a single Save roll.  You can wait until after they roll to use this ability, but you can only roll once per \RO or \RB attempt.

  \mybold{Best. Night. EVAR!!}
  People who hang out with you have a pretty great time.  You increase everyone's \mylink{Carousing}{civilization-leveling} die by \DCUP. Anyone who doesn't carouse with you has to hear about how awesome the night was the entire next day.

  \mybold{Optional: You My Boy Blue!}
  Pooka love people, and it's not uncommon for them to "bond" with a person they party with.  After you go \mylink{Carousing}{civilization-leveling} with others, pick one of the people you caroused with. You are now "bonded" to that person.  Until the next time you go Carousing, you'll favor that person over the others. If there's any extra \mylink{Grit}{combat-grit} left to distribute, you'll pick them; if there's an extra share of treasure, you'll argue for that person to get it; if you have extra narcotics, you'll give them to that person.  Next time you go Carousing, pick another person randomly ...
  ...
  \HD d6 \hfill Primary Stat: Awareness
  ...
  %%%%  MURKS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \mysection{Species: Myrkálfar}{species-murks}

  \mysubsection{Base Stats}{murks-base-stats}
  \HD d8 \hfill Primary Stat: Sanity
  ...
  \mybullet {
    \item \mybold{Deep Janeen:}   You've worked the mazes and artworks of the Janeen.  You can never get lost when traveling in the Veins. The Janeen only want the most beautiful to work their art - your starting Presence is \DCUP.  You know the difference between Lithic and Umbral architecture.
  ...
  You wear a mask to hide the truly horrible things done to you in the Veins. If you remove this mask, any human Mortal who looks at you for the first time (including allies) must immediately \RS Sanity or become Disgusted
  ...
  %%%%  NIGHT CHILDREN %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
  \mysection{Species: Night Child}{species-night-children}

  \mysubsection{Base Stats}{night-children-base-stats}
  \HD d10 \hfill Primary Stat: Talent
  ...
  \mysubsection{Professional Gear}{night-children-bonus}
  ...
  ~\\
  \mytable{l p{0.3\linewidth}p{0.6\linewidth}}{
