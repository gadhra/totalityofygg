...
\renewcommand{\yggFaeText}{%
  ...
  \mybullet {
    \item If you are a \mylink{Pooka}{species-pooka}, you can hail from any \mylink{Small, Medium, or Large}{civilization-table} in Acheron.  Pooka are commonly sailors (they bring good luck), jesters, scouts, and tavern keepers - and rarely gamblers, since no one will play with them
    ...
    \item If you are a \mylink{Murk}{species-murks}, you originally hailed from the \mylink{Veins of the Earth}{civilization-veins-of-the-earth} - but you can live in any town or city on the frontiers.
    \item If you are a \mylink{Night Child}{species-night-child}, you hail from any \mylink{Medium or Large}{civilization-table} in Acheron, or somewhere far away from \myital{any} civilization
  }
