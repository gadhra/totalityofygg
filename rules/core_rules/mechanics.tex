...
When Monsters try a \RB, they add their \HD as a modifier to their test i.e. a 6\HD Monster adds +6 to their \RB roll.  When Allies roll a \RB, they add their level as a modifier to their test, provided they are testing their \mylink{Primary Stat}{primary-stat}.
...
\myital{To the best of my knowledge, the Usage Die is a mechanic invented by David Black.}
...
Each \mylink{Mortal Trope}{mortal} has a \myanchor{Primary Stat}{primary-stat} listed below.
...
\mynumlist {
    \item \mylink{Taking a Breather}:  \\~  Takes Minutes.  More details found in \mylink{Combat}{combat-resting-breather}
    \item \mylink{Taking a Bivouac}:  \\~ Takes Hours.  More details found in \mylink{Combat}{combat-resting-bivouac}
    \item \mylink{Taking a Vacation}:  \\~ Takes Days or Weeks.  More details found in \mylink{Civilization}{civilization-vacation}
}
