...
During Combat, you may be hit with an effect or spell that has a Markovian duration.  Markovian effects happen immediately, but have a random duration over the course of Moments.  Markovian durations have a die attached to them i.e "d4 Markovian".  

At the bottom of a Moment, \RS with the die associated with the duration.  If you fail (roll a 1 or a 2), the effect immediately ends.  If you don't fail, the die moves \DCDOWN.

For example, if you were struck by a Ghast and paralyzed for d4 Markovian, you would roll a d4 at the bottom of the Moment.  If you rolled a 1 or a 2, the paralysis would end.  If you rolled a 3 or a 4, the die would move to a d3.
...
Determined by the Arbiter, see the section on \mylink{Adventures}{misc-adventuring}.
