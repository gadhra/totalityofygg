...
When Monsters attempt a \RB, they add their \HD as a modifier to their test i.e. a 6\HD Monster adds +6 to their \RB roll.  When Allies roll a \RB, they add their level as a modifier to their test, provided they are testing their \mylink{Primary Stat}{primary-stat}.
...
\myital{Examples: \mylink{Tangible Stats}{tangible-stats}; \mylink{Knowledge Dice}{magician-blood-knowledge}}
...
\myital{Examples: \mylink{Intangible Stats}{intangible-stats}; \mylink{Deed Dice}{sellsword-deed-dice}  and \mylink{Luck Dice}{knave-luck-die}; \mylink{Mojo}{devotee-faith-and-mojo}; some \mylink{equipment}{gear-adventuring} (narcotics, armor, arrows, torches, etc)}
...
\myital{Examples: \mylink{Faith Die}{devotee-faith-and-mojo}, \mylink{Blood Die}{magician-blood-knowledge}, \mylink{Grace Die}{devotee-faith-and-mojo}}


\mysubsection{Knack Dice}{dice-knack-dice}
\example{%
  \KNACK \\
...
Examples: \mylink{Saves}{saves}, \mylink{Skill Dice}{skills}
...
Each Mortal Trope has a \myanchor{Primary Stat}{primary-stat} listed below.
...
Each Fae Species has a \myanchor{Primary Stat}{primary-stat} listed below.
...
Presence is the Primary Stat for Pooka.
...
Talent is the Primary Stat for Night Children
...
Awareness is the Primary Stat for Spriggan
...
\mysubsection{Markovian}{time-markovian}

During Combat, you may be hit with an effect or spell that has a Markovian duration.  Markovian effects happen immediately, but have a random duration over the course of Moments.  Markovian durations have a duration die attached to them i.e "d4 Markovian".  
...
Each Intangible Stat starts at a d4 (though this may be modified by your Trope, Race, or Small God)
...
Your starting Flesh is the \MAX value of your \FLESH as listed under your Template.  For example, Sellswords have a \FLESH of d10, so they start with 10 Flesh.  
