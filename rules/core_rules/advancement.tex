...
\flavor{
  There comes a time, thief, when the jewels cease to sparkle, when the gold loses its luster, when the throne room becomes a prison, and all that is left is a father's love for his child. \Tilde{King Osric}
}
...
\example{
  \mylist {
    \item \mybold{If you've just reached 2nd or 3rd level}, \\~ you can pick from the Any or Iron lists; 
    \item \mybold{If you've just reached 4, 5, or 6th level}, \\~ you can pick from the Any, Iron, or Silver lists; 
    \item \mybold{If you've just reached 7, 8, or 9th level}, \\~ you can pick from the Any, Iron, Silver, or Gold lists
  }
}
  ...
  \mybullet {
    ...
    \item Learn the \mylink{The Crux of Knowledge}{philosopher-virtue-knowledge} \mybold{[Unique]}. \\~ \\~  If you already know it, move your Knowledge \DCUP \mybold{[Special]} 
  ...
  \mybullet {
    ...
    \item Learn the Liturgy of the Novitiates of your Throne or Small God.  The Liturgies of your Small God should be developed between you and the Arbiter \mybold{[Unique]} 
    \item If you know the Liturgy of the Novitiates of a Throne or Small God, you can learn that Throne or Small God's Liturgy of the Clerics \mybold{[Unique]} 
  }
  ...
  \mybullet {
    ...
    \item Gain a piece of magical material (a dragon's tooth, mithril ore, a ray of sunlight, etc) that could be used to be fashioned into a Magic Sword.  Tell the Arbiter what this material is. \mybold{[Unique]}
  ...
  \mybullet {
      ...
      \item \mybold{Doctor:}  Gain +4 to your Leechcraft rolls. 
  ...
  \mybullet {
    \item If you know the Liturgy of the Clerics of a Throne or Small God, you can learn that Throne or Small God's Liturgy of the Apostles
  ...
  \mybullet {
    ...
    \item  \mybold{Anamnesis of the Elements:} you can use your Remembrance Dice to summon and control Elemental creatures for Minutes. 

    \item  \mybold{Anamnesis of the Damned:} you can use your Remembrance Dice to summon and control Demonic creatures for Moments.
  ...
  \mybullet {
      \item You are immune to Madness, and spells of the Mind paradigm
  ...
  \mybullet {
    \item If you know the Liturgy of the Apostles of a Throne or Small God, you can learn that Throne or Small God's  Liturgy of the Saints

    \item \mybold{Fishers of Men:} Requires the Virtue \mylink{Crux of Faith}{mystic-virtue-faith}.  2 disciples of the Small God flock to your cause.  These disciples are \mylink{Henchmen}{gear-henchmen} who provide 1 d4 Faith \POOL and have Fanatic morale. If the disciples are Close to you and can see you, you may use their Faith as if it were your own.  If a disciple's Faith is ever exhausted, they will leave your service in Weeks if it is not restored.  During a \mylink{Vacation}{civilization-vacation} you can ask your disciples to make a "Test of Faith", each rolling their Faith die.  If they roll a 4, another disciple joins your cause; if they Fail (roll a 1 or a 2), they lose their Faith Die and have a Crisis of Faith.  You can never have more than 12 disciples.  

    \item \mybold{Charmed Circle:}  Requires the Virtue \mylink{Cunning}{mystic-virtue-cunning}.  A coven of 2 witches join their powers with yours.  These witches are \mylink{Henchmen}{gear-henchmen} who provide 1 d4 Cunning \POOL and have Fanatic morale; additionally, they each grant you +1 on your Mojo rolls, provided they are Close to you and can see you. You can use their Cunning  to practice Occultism during a \mylink{Vacation}{civilization-vacation}, but they must be "in sync" with you; synchronizing your Cunning with them takes a full Widdershins
uring a \mylink{Vacation}{civilization-vacation} you can choose to "draw down the moon".  Each witch rolls their Cunning Die, If they roll a 4, another witch joins the Coven; if they Fail (roll a 1 or a 2), the ritual consumes them.  You can never have more than 12 other members in your coven.  
