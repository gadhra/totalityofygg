...
you can pick from the Any, Iron, Silver, or Gold lists
 ...
 \cbreak
  ...
  \mybullet {
    ...
    \item Learn \mybold{Wonder: Staff Magic}
...
\mybullet {
  ...
  \mybullet {
    ...
    \item \mybold{Shadowblade:} You can reach into a shadow and pull out a dagger. The dagger exists for as long as it is not exposed to sunlight.  The dagger is magical and does d10 damage, and can have Toxins applied to it.  If the dagger takes a life it immediately dissapates
