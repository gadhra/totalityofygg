...
\cbreak
 ...
 \end{multicols}
  ...
  Setting a difficulty for a Knave's \mylink{Whisper}{knave-whispers} trye means picking a number between 2 and 9 (remember the Adventurer can only add a \MAX of +4 to their \KNAVE roll with their Luck).
