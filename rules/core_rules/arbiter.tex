...
\mybullet {
    \item   If the adventurer is in Combat, all Actions are take twice as long i.e.  it will take them two Maneuvers to move from Close to Nearby, two Maneuvers to get something from their pack, etc.
