...
\renewcommand{\yggArbiterText}{%
  ...
  \mybold{\mylink{Kate's Key}{knave-kates-key} } 
  ...
  \mybold{\mylink{Clockwork Sense}{knave-clockwork-sense}} 
  ...
  \mybold{\mylink{Gloomstride}{knave-gloomstride}}
  ...
  \mybold{\mylink{Monkeys' Paws}{knave-monkeys-paws}}
  ...
  \mybold{\mylink{Foyst}{whisper-foyst}} 
  ...
  \mybold{\mylink{Red Herring}{whisper-red-herring}} 
...
If you don't draw a face card, an Ace, or a Joker - nothing happens.  If you do, first check the suit :
  ...
  \mysection{The Veins}{arbiter-veins}
  ...
  \mylist {
    ...
    \item[$\square$]  Check for "bottom of the Moment" effects (including \mylink{Markovian}{duration-markovian} effects)
  }
  ...
  \mybullet {
    ...
    \item If a adventurer is \mylink{Dying}{combat-dying}, roll for a \mylink{Wound}{appendixa-wounds} right away - it might affect their Breather.
  }
  ...
  \mylist {
    ...
    * Soldiers: Restore 1 \UD of Armor up to its Max, and 1 Deed 
    * Barbarians: Restore 1 Deed \UD
  ...
  \mylist {
    ...
    \item[$\square$]  Heal one Wound
    \item[$\square$]  Restore your Armor \UD up to its \MAX.  If they need to fix its \MAX value, they'll need a Leatherworker or Smith (see below)
    ...
    \item[$\square$]  Assign {Adventuring XP}{misc-adventuring} if appropriate
    ...
    \item[$\square$]  Ask if anyone wants to {advance their Skills}{skills-advance}
    \item[$\square$]  Ask if anyone is going \mylink{Carousing}{misc-carousing} (do they have a Pooka?)
    \item[$\square$]  Check if anyone \mylink{gained a level}{misc-leveling}
  }
  ...
  }\footnote{See Bell, Book, and Candle}
