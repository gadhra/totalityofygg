...
\renewcommand{\yggCivilizationText}{%
  ...
  The size of the settlement is important when it comes to longer rests, spending treasure, and finding \mylink{equipment}{civilization-equipment}, \mylink{services}{civilization-services}, and \mylink{hirelings}{civilization-hirelings}.
  ...
  \mybullet {
    ...
    \item Restore your Armor \UD up to its \MAX
    ...
    \item Restore all Mojo \UD and shift your Mojo (Witches)
    \item Restore all Grace \POOL (Mystics)
  }

  Additionally you maybe able to (depending on the size of the Settlement)
  \mybullet {
    \item Find a Trader to buy Gear
    \item Pay a Leatherworker to repair Light Armor
    \item Pay a Smith to repair Medium or Heavy Armor, or to buy weapons
    \item Worship at the shrine of a certain Small God
    \item Buy narcotics
    \item Visit a sanitarium or a witch or wisewoman
  }
