...
\mybullet {
  ...
  \item Level Drain (d4): Save vs. Hexes or roll on the \mylink{Life Drain}{appendixa-wounds-life-drain} table
...
Whenever a Ghost hits Flesh, Save vs. Doom or  immediately roll on the \mylink{Life Drain}{appendixa-wounds-life-drain} table
...
\mylist {
  \item First roll is the dragon's color: 1) Red, 2) Black, 3) White, 4) Blue, 5) Green, 6) Bone
  \item Second roll is the dragon's size: 1) Small, 2) Middling, 3) Large, 4) Huge, 5) Colossal, 6) Titanic
  \item Third roll is the dragon's age: 1) Juvenile, 2) Adult, 3) Old, 4) Very Old, 5) Ancient, 6) Wyrm
}
