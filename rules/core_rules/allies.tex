...
\renewcommand{\yggAlliesText}{%
  ...
  \mybullet {
    \item If you are a \mylink{Pooka}{class-pooka}, you can hail from any city in Acheron.  Pooka are commonly sailors (they bring good luck), jesters, scouts, and tavern keepers - and rarely gamblers, since no one will play with them
    \item If you are a \mylink{Spriggan}{class-spriggan}, you originally hailed from Elfland - but can live in or near any town or city bordering the Great Wood.
    \item If you are a \mylink{Murk}{class-murk}, you originally hailed from the Veins of the Earth - but you can live in any town or city on the frontiers.
    \item If you are a \mylink{Night Child}{class-night-child}, you hail from any city in Acheron, or somewhere far away from smaller civilization.
  }
  ...
  Each Intangible Stat starts at a d4 (though this may be modified by your Class or Small God)
  ...
  \mybold{Step 5: Choose your \mylink{Class}{class} and \mylink{Flavor}{flavor}}
  ...
  \mybold{Step 7:  \mylink{Flesh and Grit}{combat-flesh}}
  ...
  Roll your \VIG.  If the total is greater than your current Flesh, your Flesh is that number instead (i.e. if you roll a 6 and you have 4 Flesh, your Flesh is now 6). \mylink{Sellswords}{class-sellsword} (Soldiers and Barbarians) can add their \LVL to this roll, but no other modifiers.
