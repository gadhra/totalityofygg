...
\renewcommand{\yggCombatText}{%
  ...
  \mybullet {
    \item Combat consists of Moments and takes Minutes to finish.    
    \item If you roll \mylink{Init}{combat-init}, you're in Combat. You can take 1 or 2 \mylink{Actions}{combat-actions} per \mylink{Moment}{combat-time} depending on your Init.
    \item Everyone who rolls Init is an Ally.  Everyone else is a Monster
    \item You can take a Breather immediately after Combat (but not during!)
  }
  ...
  \mytable{X r}{
    \thead{\mylink{Armor}{civilization-armor}} & \thead{\MD} \\
  }{
    None & d20 \STATIC \\
    Light & d12 \STATIC \\
    Medium & d8 \STATIC \\
  ...
  Most Monsters have a speed of d16.  Some Monsters are Fast - their speed is d12.  Some Monsters are Slow - their speed is d20.  See the section on \mylink{Monsters}{arbiters-resources-monsters} for more details.
  ...
  It's also possible to be surprised \myital{during} Combat - this is called "The Drop".  In order to get the Drop, a Knave must spend 2 Maneuvers getting out of sight, creeping through the shadows and getting into position (usually making a Skulk roll).  On their 3rd Action, they can attempt a Murder.

  \mysubsection{Actions}{combat-actions}

  You can take 1 or 2 Actions in a Moment, depending on your Init roll. If you \RO on your Init check, you can take 1 Action \mybold{before} the Monster and 1 Action \mybold{after} the Monster. If you fail, you can only take 1 Action \mybold{after} the Monster. You can always choose to act after - there's no need to roll at that point. You can act as a group and decide your own order for Actions in each Moment. 
  ...
  Your Fight \RO depends on whether you're using a Hard weapon (\VIG) or a Fast weapon (\DEX).  Weapon types are found in \mylink{Equipment}{civilization-equipment-weapons}

  If you succeed in your Fight \RO test, you deal damage to the Monster.

  \myhighlight{Dealing Damage}{combat-dealing-damage}

  The damage your weapon does is a \STATIC die.  Weapon damage is found in \mylink{Equipment}{civilization-equipment-weapons}.  You roll the \STATIC and deal that much damage to the Monster.

  If you roll a natural 1 for damage (or someone turns your die roll into a natural 1), test your  \RS : \DEX.  If you get a Failure, your attack is a \mylink{Fumble}{appendixa-combat-tables-fumbles}
  ...
  If you bring someone to 0 Flesh via Unarmed combat, they are \mylink{Knocked Out}{effects-knocked-out} for d4 \mylink{Markovian}{effects-markovian}.  Continued Unarmed attacks against Knocked Out foes prompt Death's Door rolls as you beat them to death.
  ...
  \mynumlist {
    \item \mybold{Shield} : If you have a shield equipped (that is, on your arm) and take \mybold{physical damage} , you can perform the \mylink{Mighty Deed of Arms: Splinter}{combat-actions-splinter} (this counts as your Fight Action for the Moment; if you already took your Fight Action, you can't use this). The shield is sundered and you take no damage. Stop here.  Otherwise ...
  ...
  Flesh is your ability to withstand injury; Grit is your ability to avoid injury in the first place.  Damage affects Grit first - close calls, little nicks, stunning blows, getting worn out from the fight, etc. When Grit is gone you're too exhausted to ward off physical harm and you start taking Flesh damage. 

  TK TK TK TK more details here


  \mysubsection{Dying}{combat-dying}

  If your Flesh ever goes to 0 or below, you are on \mybold{Death's Door} .  Your Grit immediately drops to 0 if it isn't 0 already (you can't duck, dive, dodge, dip and dive while trying to hold your intestines in, right?) and your Flesh is set to 0.
  ...
  You can't heal Grit while you are on Death's Door.  If you are healed above 0 Flesh (through Resting, Leechcraft, etc), you are no longer on Death's Door.  Your Death Die resets and you must roll on the \mylink{Wound table}{arbiters-resources-wounds} as well as roll your Sanity \UD.  Note that some Wounds will prevent you from healing Grit until they are dealt with.


  \myhighlight{The Death Die}{combat-death-die}

  While you are on Death's Door, you must \RS : \DEATH any time you take damage or do something strenuous (fighting or running counts, crawling off to a corner doesn't). If you succeed, the \DEATH moves \DCDOWN. If you fail you perish at the \mylink{top of the next Moment}{time-top-bottom} (if you're lucky, you can be healed before that happens).

  \mybold{Optional: Heinous Damage}

  If you ever take 4x your \MAX Flesh in damage, and the result brings you to Death's Door, you perish at the \mylink{top of the next Moment}{time-top-bottom} as if you had failed your \RS : \DEATH i.e. if you were a Bravo with 8 Flesh and took 32 damage, you would perish at the \mylink{top of the next Moment}{time-top-bottom}
  ...
  You take an Action to be come \mylink{Enraged}{effects-enraged}.  The target of the rage is "the Monsters". If one of your Allies has injured you in this fight, they count as a Monster.
  ...
  \myhighlight{Mighty Deeds of Arms}{combat-deeds}
  ...
  Try a Fight \RO; if you succeed, your opponent is \mylink{Disarmed}{effects-disarmed}
  ...
  \mysubsection{Longer Rests}{combat-resting-longer-rests}
