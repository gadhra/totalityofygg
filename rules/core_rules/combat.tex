...
\renewcommand{\yggCombatText}{%
  ...
  If you bring someone to 0 Flesh via Unarmed combat, they are \mylink{Knocked Out}{effects-knocked-out} for d4 \mylink{Markovian}{effects-markovian}.  Continued Unarmed attacks against Knocked Out foes prompt \DEATH rolls as you beat them to death.
  ...
  \mynumlist {
    \item \mybold{Shield} : If you have a shield equipped (that is, on your arm) and take \mybold{physical damage} , you can perform the \mylink{Mighty Deed of Arms: Splinter}{combat-action-splinter} (this counts as your Fight Action for the Moment; if you already took your Fight Action, you can't use this). The shield is sundered and you take no damage. Stop here.  Otherwise ...
  ...
  You can't heal Grit while you are on Dying.  If you are healed above 0 Flesh (through Resting, Leechcraft, etc), you are no longer on Dying.  Your Death Die resets and you must roll on the \mylink{Wound table}{arbiters-resources-wounds} as well as roll your Sanity \UD.  Note that some Wounds will prevent you from healing Grit until they are dealt with.
