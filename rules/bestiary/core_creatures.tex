...
\renewcommand{\yggCoreCreatures}{%
  \mychapter{Core Creatures}{core-creatures}
}

\renewcommand{\yggCoreCreaturesText}{%
...
\MONSTERBLOCK[
  Name=Unquiet Spirit,
  Link=monster-unquiet-spirit,
  MV=Base,
  WK=varies,
  DMG=d4 1 Close + Life Drain,
  HD=varies,
  Power=Weak,
  Soak=0,
  Morale=Orderly,
...
Unquiet spirits sap energy from their victims unless the victim \RB using \FOC.  If the adventurer fails, roll a d6:
...
\mylist {
    \item Appartion: 1HD, Save 1, Wk d24, Foc: d4
    \item Spook: 3HD, Save 2, Wk d20, Foc: d8
    \item Phantom: 5HD, Save 3, Wk d16,  Foc: d12
    \item Shadow: 6HD, Save 4, Wk d12.  Foc: d20
}
...
\mylist {
  \item \mybold{Red:}   Fire.  Roll a Talent check, or catch fire.  Take d4 damage at the top of each Moment until you spend an entire Moment doing "stop, drop, and roll".  This can be shortened to a single Maneuver if someone helps you.
